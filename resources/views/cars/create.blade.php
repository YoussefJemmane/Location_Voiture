                ...
                <div class="  ">
                    ...
                    <div class="pr-6 lg:pt-0 md:pt-5 ">
                        ...
                        <div
                            ...
                            <form class="space-y-6 " action="{{ route('vehicules.store') }}" method="post"
                                enctype="multipart/form-data">
                                @csrf

                                    <h5 class="text-xl font-medium text-gray-900 dark:text-white">Create Car</h5>
                                    <h5 class="text-xl font-medium text-gray-900 dark:text-white">Create Model</h5>
                                    <div>
                                        <label for="marque"
                                    ...
                                    <div>
                                        <label for="prixJour"
                                            ...
                                            Jour</label>
                                        <input type="text" name="prixJour" id="prixJour" placeholder="120"
